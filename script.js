...
function getAgentResponse(message) {
    ...
    if (lowerMessage.includes('project') || lowerMessage.includes('fitness') || lowerMessage.includes('tracker') || lowerMessage.includes('emotion') || lowerMessage.includes('voice') || lowerMessage.includes('student') || lowerMessage.includes('analysis') || lowerMessage.includes('analytics')) {
        return "Kavin has three major projects listed: \n1) **Student Analysis Portal** (React, NodeJS, Express, MongoDB, Chart.js) - Deployed portal for tracking, filtering, and analyzing student grades and academic performance.\n2) **Health & Fitness Tracker Web App** (Flask, Python, SQLite, Chart.js) - monitors steps, calories, workout logs with secure auth.\n3) **Voice Based Emotion Tracker** (Flask, Python, SQLite, Chart.js) - analyzes user voice through a mic to classify emotions using ML/DL features.";
    }
