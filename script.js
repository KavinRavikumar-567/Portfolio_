...
function getAgentResponse(message) {
    ...
    if (lowerMessage.includes('project') || lowerMessage.includes('fitness') || lowerMessage.includes('tracker') || lowerMessage.includes('emotion') || lowerMessage.includes('voice')) {
        return "Kavin has two major projects listed: \n1) **Health & Fitness Tracker Web App** (Flask, Python, SQLite, Chart.js) - monitors steps, calories, workout logs with secure auth.\n2) **Voice Based Emotion Tracker** (Flask, Python, SQLite, Chart.js) - analyzes user voice through a mic to classify emotions using ML/DL features.";
    }
